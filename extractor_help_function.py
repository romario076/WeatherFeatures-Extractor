...
def getNasaPower(startdate, enddate, lat, lon, parameters):
    ...
    data = []
    #url = 'https://power.larc.nasa.gov/cgi-bin/v1/DataAccess.py?&request=execute&identifier=SinglePoint&parameters=TS,T2M_MAX,T2M_MIN,T2M&startDate={2}&endDate={3}&userCommunity=SSE&tempAverage=DAILY&outputList=CSV&lat={0}&lon={1}'
